...
@ApiTags('channel_account_message')
@Controller('channel-account-message')
export class ChannelAccountMessageController {
  constructor(
    private readonly channelAccountMessageService: ChannelAccountMessageService,
  ) {}

  @Post()
  create(
    @Body() createChannelAccountMessageDto: CreateChannelAccountMessageDto,
  ) {
    return this.channelAccountMessageService.create(
      createChannelAccountMessageDto,
    );
  }
  ...
  update(
    @Param('id') id: string,
    @Body() updateChannelAccountMessageDto: UpdateChannelAccountMessageDto,
  ) {
    return this.channelAccountMessageService.update(
      +id,
      updateChannelAccountMessageDto,
    );
  }
